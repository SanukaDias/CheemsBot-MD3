   ...
   case 'les1': case 'les2': case 'les3': case 'les4': case 'les5': case 'les6': case 'les7': case 'les8': case 'les9': case 'les10': case 'les11': case 'les12': case 'les13': case 'les14': case 'les15': case 'les16': case 'les17': case 'les18': case 'les19': case 'les20':
    ...
    if (command == "les4") {
        await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les4.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les18") {
        await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les18.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les1") {
        await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les1.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les2") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les2.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les3") {
        await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les3.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les5") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les5.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les6") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les6.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les7") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les7.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les8") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les8.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les9") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les9.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )

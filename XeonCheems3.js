//Version 1 mchan. lkkk namasthee//
...
//Lesbian Menu By chxmiyz//

   case 'les1': case 'les2': case 'les3': case 'les4': case 'les5': case 'les6': case 'les7': case 'les8': case 'les9': case 'les10': case 'les11': case 'les12': case 'les13': case 'les14': case 'les15': case 'les16': case 'les17': case 'les18': case 'les19': case 'les20':
}
    if (command == "les4") {
        await XeonBotInc.sendMessage(
            clientJID, 
            { 
                m.mtype: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les4.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les18") {
        await XeonBotInc.sendMessage(
            clientJID, 
            { 
               m.mtype:  url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les18.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les1") {
        await XeonBotInc.sendMessage(
            clientJID, 
            { 
                m.mtype: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les1.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les2") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                m.mtype: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les2.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les3") {
        await XeonBotInc.sendMessage(
            clientJID, 
            { 
                m.mtype: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les3.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les5") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                m.mtype: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les5.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les6") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                m.mtype: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les6.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les7") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                m.mtype: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les7.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les8") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                m.mtype: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les8.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les9") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                m.mtype: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les9.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les10") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les10.mp4?raw=true' },
                caption: "Memosa"           
            },          
            {quoted:msg}
        )
    ...
    if (command == "les11") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les11.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les12") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les12.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les13") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les13.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les14") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les14.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les16") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les16.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les15") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les15.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les17") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les17.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les20") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les20.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "les19") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Memosachamiya/Gojo-Satoru/blob/master/GojoMedia/vid/les19.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "hanavid") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/0h1qikd7upuku8c9fudk5_source-p5dPxpqw.mp4?raw=true' },
                caption: "Memosa"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard1") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard1.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard2") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard2.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard3") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard3.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard4") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard4.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard5") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard5.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard6") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard6.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard7") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard7.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard8") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard8.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard9") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard9.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard10") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard10.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard11") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard11.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard12") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard12.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
    ...
    if (command == "hard13") {
       await XeonBotInc.sendMessage(
            clientJID, 
            { 
                video: { url: 'https://github.com/Amogus10/hannah/blob/main/Hard_core_videos/Hard13.mp4?raw=true' },
                caption: "Memosa 💕"
            },
            {quoted:msg}
        )
